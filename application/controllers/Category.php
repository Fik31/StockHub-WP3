	...
	public function fetchCategoryData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if (in_array('updateCategory', $this->permission)) {
				$buttons .= '<center><button type="button" class="btn btn-warning btn-sm" onclick="editFunc(' . $value['id'] . ')" data-toggle="modal" data-target="#editModal"><i class="fa fa-pencil"></i></button>';
			}
