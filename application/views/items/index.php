   ...
   <div class="modal fade" tabindex="-1" role="dialog" id="addBrandModal">
     <div class="modal-dialog" role="document">
       <div class="modal-content">
         ...
         <form role="form" action="<?php echo base_url('Items/create') ?>" method="post" id="createBrandForm">
   ...
   <div class="modal fade" tabindex="-1" role="dialog" id="editBrandModal">
     <div class="modal-dialog" role="document">
       <div class="modal-content">
         ...
         <form role="form" action="<?php echo base_url('Items/update') ?>" method="post" id="updateBrandForm">
   ...
   <div class="modal fade" tabindex="-1" role="dialog" id="removeBrandModal">
     <div class="modal-dialog modal-sm" role="document">
       ...
       <div class="modal-content">
         ...
         <form role="form" action="<?php echo base_url('Items/remove') ?>" method="post" id="removeBrandForm">
           <div class="modal-body">
