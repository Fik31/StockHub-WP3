      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createUser', $user_permission)): ?>
            <a href="<?php echo base_url('Members/create') ?>" class="btn btn-primary">Add New</a>
            <br /> <br />
          <?php endif; ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if(in_array('updateUser', $user_permission)): ?>
                            <center><a href="<?php echo base_url('Members/edit/'.$v['user_info']['id']) ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                          <?php endif; ?>
                          <?php if(in_array('deleteUser', $user_permission)): ?>
                            <a href="" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_users<?php echo $v['user_info']['id']; ?>"><i class="fa fa-trash"></i></a></center>
                            ...
                            <div class="modal-dialog modal-sm">
                              <div class="modal-content">
                                ...
                                <form action="<?php echo base_url('Members/delete/'.$v['user_info']['id']) ?>" method="post">
