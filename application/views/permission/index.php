    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if (in_array('createGroup', $user_permission)): ?>
          <a href="<?php echo base_url('Permission/create') ?>" class="btn btn-primary">Add Permission</a>
          <br /> <br />
        <?php endif; ?>
                      ...
                      <?php if (in_array('updateGroup', $user_permission) || in_array('deleteGroup', $user_permission)): ?>
                        <td>
                          <?php if (in_array('updateGroup', $user_permission)): ?>
                            <a href="<?php echo base_url('Permission/edit/' . $v['id']) ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                          <?php endif; ?>
                              ...
                              <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <form action="<?php echo base_url('Permission/delete/' . $v['id']) ?>" method="post">
